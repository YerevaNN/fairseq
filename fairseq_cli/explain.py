...
def plot_mlot(reg_model, nnotzero, nonzero_positions, acc, roc_auc, trX, trY, vaX, vaY, model_path, data_path):
    ...
    log_save_dir = Path(f"./logs/{data_path}/{model_path}")
    log_save_dir.mkdir(parents=True, exist_ok=True)

    dist_save_dir = Path(f"./logs/{data_path}/{model_path}/dist")
    dist_save_dir.mkdir(parents=True, exist_ok=True)

    auc_roc_save_dir = Path(f"./logs/{data_path}/{model_path}/auc_roc")
