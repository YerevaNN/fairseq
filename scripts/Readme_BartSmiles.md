...
1) Download and preprocess MoleculNet datasets:  python process_moleculenet_new.py --dataset-name esol --is-MoleculeNet True from the /home/gayane/BartLM/fairseq/scripts
...
2) Generate the grid of training hyperparameters scripts/generate_grid_bartsmiles. This will create a csv.
    ...
    This will write grid search parameters in "/home/gayane/BartLM/fairseq/scripts/YerevaNN Chemical Results - Apr25.csv" file.
...
4) Train the models 
CMD: python /home/gayane/BartLM/fairseq/scripts/train_grid_bartsmiles.py. 
...
6) Perform SWA and evaluate scripts/evaluate_swa_bartsmiles.py. This will produce a log file with output and averaged checkpoints respectivly in   /home/gayane/BartLM/Bart/chemical/log/  and /mnt/good/gayane/data/chkpt/clintox_1_bs_16_dropout_0.1_lr_5e-6_totalNum_739_warmup_118/ folders.
