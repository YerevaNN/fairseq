...
for i in range(len(names)):
    ...
    cmd = f"""python /home/gayane/BartLM/fairseq/scripts/compute_auc.py --inp-count 2 --lr {lr} --dropout {drout}{noise_params} --dataset-name {task_name} --subtask 1 --warmup-update {warmup_updates} --total-number-update {total_num_update} --checkpoint_name checkpoint_best.pt >> /home/gayane/BartLM/Bart/chemical/log/Ames_fp.log""" 
    ...
    cmd = f"""python /home/gayane/BartLM/fairseq/scripts/compute_auc.py  --inp-count 2 --lr {lr} --dropout {drout} {noise_params} --dataset-name {task_name} --subtask 1 --warmup-update {warmup_updates} --total-number-update {total_num_update} --checkpoint_name {chkpt_name_best_val_loss}.pt >> /home/gayane/BartLM/Bart/chemical/log/Ames_fp.log""" 
    ...
    cmd = f"""python /home/gayane/BartLM/fairseq/scripts/compute_auc.py  --inp-count 2 --lr {lr} --dropout {drout} {noise_params} --dataset-name {task_name} --subtask 1 --warmup-update {warmup_updates} --total-number-update {total_num_update} --checkpoint_name {chkpt_name_best_val_acc}.pt >> /home/gayane/BartLM/Bart/chemical/log/Ames_fp.log""" 
    print("---------------------> chkpt_name_best_val_acc SWA score: ", cmd)
    os.system(cmd)


    cmd = f"""python /home/gayane/BartLM/fairseq/scripts/compute_auc.py  --inp-count 2  --lr {lr} --dropout {drout} --dataset-name {task_name} {noise_params} --subtask 1 --warmup-update {warmup_updates} --total-number-update {total_num_update} --checkpoint_name checkpoint{best_val_accuracy[i]}.pt >> /home/gayane/BartLM/Bart/chemical/log/Ames_fp.log""" 
    ...
    cmd = f"""python /home/gayane/BartLM/fairseq/scripts/compute_auc.py  --inp-count 2  --lr {lr} --dropout {drout} --dataset-name {task_name} {noise_params} --subtask 1 --warmup-update {warmup_updates} --total-number-update {total_num_update} --checkpoint_name {chkpt_name_last}.pt >> /home/gayane/BartLM/Bart/chemical/log/Ames_fp.log""" 
