...
import numpy as np
from fairseq.data.fairseq_dataset import EpochListening
...
@register_task("multi_input_sentence_prediction", dataclass=MultiInputSentencePredictionConfig)
class MultiInputSentencePredictionTask(FairseqTask):
    """
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        input1_path = get_path("input1", split)
        input1_path = input1_path.replace("processed/input1", "raw").replace(split, f"{split}.input1")
