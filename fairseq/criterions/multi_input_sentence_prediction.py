...
@register_criterion("multi_input_sentence_prediction", dataclass=MultiInputSentencePredictionConfig)
class MultiInputSentencePredictionCriterion(FairseqCriterion):
    def __init__(self, cfg: MultiInputSentencePredictionConfig, task):
        super().__init__(task)
